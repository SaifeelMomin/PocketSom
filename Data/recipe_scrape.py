...
for food in foods[1501:]:
    ...
    driver.get(url)
    try:
        recipeLink = driver.find_element_by_xpath(
            "//*[@id='fixedGridSection']/article[2]/div[2]/h3/a/span"
        )
        recipeLink.click()
    except selenium.common.exceptions.NoSuchElementException:
        try:
            recipeLink = driver.find_element_by_xpath(
                "//*[@id='fixedGridSection']/article[3]/div[2]/h3/a/span"
            )
            recipeLink.click()
        except:
    ...
    try:
        recipe_facts[food] = driver.find_element_by_class_name(
            "nutrition-summary-facts"
        ).text
    except:
        try:
            recipe_facts[food] = driver.find_element_by_xpath(
                "/html/body/div[1]/div/main/div[1]/div[2]/div[1]/div[2]/div[2]/section[2]/div/div[2]"
            ).text
        except:
            recipe_facts[food] = "no recipe match found"
            continue
