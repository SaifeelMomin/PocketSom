(function() {
    d3.csv('../Data/herbacious.csv')
        .then(data => {
            ...
            const layout = {
                title: 'Average Nutrition Values of Food Pairings by the Wine Tasting Metric: Herbacious',
                xaxis: {
            ...
            Plotly.newPlot('herb', [trace1, trace2, trace3, trace4, trace5, trace6], layout)
        })
