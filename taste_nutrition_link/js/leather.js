(function() {
    d3.csv('../Data/leather.csv')
        .then(data => {
            ...
            const layout = {
                title: 'Average Nutrition Values of Food Pairings by the Wine Tasting Metric: Leather',
                xaxis: {
            ...
            Plotly.newPlot('leather', [trace1, trace2, trace3, trace4, trace5, trace6], layout)
        })
