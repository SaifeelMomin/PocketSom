(function() {
    d3.csv('../Data/astringent.csv')
        .then(data => {
            ...
            const layout = {
                title: 'Average Nutrition Values of Food Pairings by the Wine Tasting Metric: Astringent',
                xaxis: {
            ...
            Plotly.newPlot('astringent', [trace1, trace2, trace3, trace4, trace5, trace6], layout)
        })
