(function() {
    d3.csv('../Data/stone_fruit.csv')
        .then(data => {
            ...
            const layout = {
                title: 'Average Nutrition Values of Food Pairings by the Wine Tasting Metric: Stone Fruit',
                xaxis: {
            ...
            Plotly.newPlot('stone', [trace1, trace2, trace3, trace4, trace5, trace6], layout)
        })
