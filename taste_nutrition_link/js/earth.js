(function() {
    d3.csv('../Data/earth.csv')
        .then(data => {
            ...
            const layout = {
                title: 'Average Nutrition Values of Food Pairings by the Wine Tasting Metric: Earth',
                xaxis: {
            ...
            Plotly.newPlot('earth', [trace1, trace2, trace3, trace4, trace5, trace6], layout)
        })
