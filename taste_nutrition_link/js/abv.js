(function() {
    d3.csv('/taste_nutrition_link/Data2/abv.csv')
        .then(data => {
            console.log(data)
            console.log(data.forEach(entry => entry.ABV))            
            const trace1 = {
            ...
            const layout = {
                title: 'Tasting Metric: ABV, Nutrition Correlation',
                xaxis: {
                    title: 'Intensity',
                  },
                  yaxis: {
            ...
            Plotly.newPlot('abv', [trace1, trace2, trace3, trace4, trace5, trace6], layout)
        })
