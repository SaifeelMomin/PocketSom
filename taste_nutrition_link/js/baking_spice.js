(function() {
    d3.csv('../Data/baking_spice.csv')
        .then(data => {
            ...
            const layout = {
                title: 'Average Nutrition Values of Food Pairings by the Wine Tasting Metric: Baking Spice',
                xaxis: {
            ...
            Plotly.newPlot('spice', [trace1, trace2, trace3, trace4, trace5, trace6], layout)
        })
