(function() {
    d3.csv('../Data3/veggies.csv')
        .then(data => {
            ...
            const layout = {
                title: 'Pairing Ratings by Vegetable Groups',
                barmode: 'group',
                xaxis: {
            ...
            Plotly.newPlot('veggies', [trace1, trace2, trace3, trace4, trace5, trace6, trace7, trace8, trace9], layout)
        })
