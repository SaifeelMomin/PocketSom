(function() {
    d3.csv('../Data3/spices.csv')
        .then(data => {
            ...
            const layout = {
                title: 'Pairing Ratings by Spice Group',
                barmode: 'group',
                xaxis: {
            ...
            Plotly.newPlot('spices', [trace1, trace2, trace3, trace4, trace5, trace6, trace7, trace8, trace9], layout)
        })
