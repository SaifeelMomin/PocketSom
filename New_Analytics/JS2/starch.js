(function() {
    d3.csv('../Data3/starch.csv')
        .then(data => {
            ...
            const layout = {
                title: 'Pairing Ratings by Starch Group',
                barmode: 'group',
                xaxis: {
                    title: 'Types of Starch',
                  },
                  yaxis: {
                    title: 'Pairing Rating',
                  }
            }
            Plotly.newPlot('starch', [trace1, trace2, trace3, trace4, trace5, trace6, trace7, trace8, trace9], layout)
        })
